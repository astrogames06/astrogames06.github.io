...
function showRate() {
    ...
    try {
        ...
        isRate = e.getItem("9nrsfz178lbr:isRate");
    } catch (t) { }
    ...
    if (isRate === "0") {
        ...
        if (msgdlg) {
            ...
            msgdlg.commands.append(new Windows.UI.Popups.UICommand(msgGoBtn, function () {
                var url = new Windows.Foundation.Uri("ms-windows-store://review/?ProductId=9nrsfz178lbr");
                Windows.System.Launcher.launchUriAsync(url);

                try {
                    var e = window.localStorage;
                    e.setItem("9nrsfz178lbr:isRate", "1");
                } catch (t) { }
            }));
