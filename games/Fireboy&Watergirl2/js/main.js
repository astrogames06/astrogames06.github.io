...
function showRate() {
    ...
    try {
        ...
        isRate = e.getItem("9pcx1n2mzbc1:isRate");
    } catch (t) { }
    ...
    if (isRate === "0") {
        ...
        if (msgdlg) {
            ...
            msgdlg.commands.append(new Windows.UI.Popups.UICommand(msgGoBtn, function () {
                var url = new Windows.Foundation.Uri("ms-windows-store://review/?ProductId=9pcx1n2mzbc1");
                Windows.System.Launcher.launchUriAsync(url);

                try {
                    var e = window.localStorage;
                    e.setItem("9pcx1n2mzbc1:isRate", "1");
                } catch (t) { }
            }));
